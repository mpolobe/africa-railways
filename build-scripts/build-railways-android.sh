...
################################################################################
# 🚂 AFRICA RAILWAYS ANDROID BUILD SCRIPT
# 
# Builds the Africa Railways Sovereign Hub Android app
...
echo -e "  Package: com.mpolobe.africarailways.hub"
...
# Start build
echo -e "${GOLD}🚀 Starting Android Build...${NC}"
echo ""
