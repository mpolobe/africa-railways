...
def generate_smart_contract_constants():
    ...
    print(f"address constant {REWARD_TOKEN}_TOKEN = 0xC9c7A437D2F2992d88E3137A473c2e0bAd696477; // Polygon")
    print(f"address constant {GOVERNANCE_TOKEN}_TOKEN = 0xC9c7A437D2F2992d88E3137A473c2e0bAd696477; // Polygon")
    print()
